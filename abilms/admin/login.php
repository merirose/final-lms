...
if(isset($_POST["btn_username"])){
	...
	if(mysqli_num_rows($qry)>0){
		...
		$msg_username='
			<div id="login-alert" class="alert alert-danger col-sm-12">Username is incorrect</div>
		';
		$form_username="block";
		$form_password="none";
	}
	...
	if(mysqli_num_rows($qry)>0){
		...
		$msg_password='
			<div id="login-alert" class="alert alert-danger col-sm-12">Password is incorrect</div>
		';
		$form_username="none";
		$form_password="block";
	}
							...
							<div style="margin-bottom: 25px" class="input-group">
                                ...
                                <div style="margin-top:10px" class="form-group">
                                	<div class="col-sm-12 controls">
                                      <input type="submit" id="btn_username" name="btn_username" class="btn btn-info btn-block btn-large" value="Next"></a>
					...
					<?php echo $msg_password;?>
						<form id="form_password" class="form-horizontal" role="form" method="post" action='<?php echo $_SERVER["PHP_SELF"];?>'>
							...
							<div style="margin-bottom: 25px" class="input-group">
                                ...
                                <div style="margin-top:10px" class="form-group">
                                	<div class="col-sm-12 controls">
                                      <input type="submit" id="btn_password" name="btn_password" class="btn btn-info btn-block btn-large" value="Login"></a>
