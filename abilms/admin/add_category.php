...
if(isset($_POST["btn_edit"])){
	$category_image=$_POST["hide_category_image"];
	if(!empty($_FILES["text_category_image"]["name"])){
		...
		$target_path= "../images/lectures/".$imagename;
			if(move_uploaded_file($temp_name, $target_path)){
				unlink("../images/lectures/".$_POST["hide_category_image"]);
...
$top_category_id=mres($con,$_POST["top_category_id"]);
$qry=mysqli_query($con,"update table_category set category_name='".$category_name."', category_image='".$category_image."', category_order='".$category_order."',top_category_id='".$top_category_id."' where category_id='".$category_id."'");
				...
				<div class="panel panel-warning">
					<div class="panel-heading">
						...
						<div class="panel-body">
							...
							<input type="hidden" name="hide_category_image" value="<?php echo $category_image;?>">
                                ...
                                <div style="margin-top:10px" class="form-group">
                                	<div class="col-sm-12 controls">
                                		<?php if(!isset($_GET["edit_id"])){
                                			echo '<input type="submit" id="btn_save" name="btn_save" class="btn btn-warning btn-block btn-large" value="Save"></a>';

                                		}

 										else {
                                			echo '<input type="submit" id="btn_edit" name="btn_edit" class="btn btn-warning btn-block btn-large" value="Edit"></a>';
