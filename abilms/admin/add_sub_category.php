                                ...
                                <div style="margin-top:10px" class="form-group">
                                	<div class="col-sm-12 controls">
                                		<?php if(!isset($_GET["edit_id"])){
                                			echo '<input type="submit" id="btn_save" name="btn_save" class="btn btn-danger btn-block btn-large" value="Save"></a>';

                                		}

 										else {
                                			echo '<input type="submit" id="btn_edit" name="btn_edit" class="btn btn-danger btn-block btn-large" value="Edit"></a>';
